package br.com.pokedex.pokemons.list.fragment
...
import br.com.pokedex.features.pokemons.presentation.R
import br.com.pokedex.features.pokemons.presentation.databinding.FragPokemonsListBinding
...
internal class PokemonsListFragment private constructor() :
    ...
    private fun onLoadItems(result: Pair<List<PokemonItem>?, String?>) =
        with(binding) {
